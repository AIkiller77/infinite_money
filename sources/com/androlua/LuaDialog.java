...
public class LuaDialog extends AlertDialog implements DialogInterface.OnClickListener {
    private Context a;
    private ListView b = new ListView(this.a);
    private String c;
    private String d;
    private View e;
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        if (this.f != null) {
            this.f.onClick(this, getButton(i));
        }
    }
    ...
    public void setItems(String[] strArr) {
        setAdapter(new ArrayListAdapter(this.a, 17367043, new ArrayList(Arrays.asList(strArr))));
    ...
    public void setMultiChoiceItems(CharSequence[] charSequenceArr, int[] iArr) {
        setAdapter(new ArrayListAdapter(this.a, 17367056, new ArrayList(Arrays.asList(charSequenceArr))));
        this.b.setChoiceMode(2);
        for (int itemChecked : iArr) {
            this.b.setItemChecked(itemChecked, true);
        }
    }
    ...
    public void setSingleChoiceItems(CharSequence[] charSequenceArr, int i) {
        setAdapter(new ArrayListAdapter(this.a, 17367055, new ArrayList(Arrays.asList(charSequenceArr))));
