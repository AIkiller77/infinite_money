...
public class LuaThread extends Thread implements LuaGcable, LuaMetaTable, Runnable {
    ...
    private class ThreadHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case 0:
                    LuaThread.this.a(data.getString("data"), (Object[]) data.getSerializable("args"));
                    return;
                case 1:
                    LuaThread.this.d(data.getString("data"), (Object[]) data.getSerializable("args"));
                    return;
                case 2:
                    LuaThread.this.a(data.getString("data"), new Object[0]);
                    return;
                case 3:
    ...
    private void a() {
        ...
        if (this.d instanceof LuaActivity) {
            ...
            new JavaFunction(this.b) {
                public int execute() {
                    LuaThread.this.d.set(this.b.toString(2), this.b.toJavaObject(3));
                    return 0;
                }
            }.register("set");
            new JavaFunction(this.b) {
    ...
    public void d(String str, Object... objArr) {
        try {
            ...
            this.d.sendError(toString() + " " + str, e2);
        }
    }
