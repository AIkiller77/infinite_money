    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas canvas, float f, float f2, Rect rect) {
            if (this.mShowArrow) {
                ...
                this.mArrow.offset(((float) ((this.mRingCenterRadius * Math.cos(0.0d)) + ((double) rect.exactCenterX()))) - f3, (float) ((this.mRingCenterRadius * Math.sin(0.0d)) + ((double) rect.exactCenterY())));
                this.mArrow.close();
