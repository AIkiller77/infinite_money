...
public class ViewDragHelper {
    ...
    private ViewDragHelper(Context context, ViewGroup viewGroup, Callback callback) {
        if (viewGroup == null) {
            ...
            this.f9q = new Scroller(context, v);
        }
    }
    ...
    private boolean a(int i2, int i3, int i4, int i5) {
        ...
        int i7 = i3 - top;
        if (i6 == 0 && i7 == 0) {
            this.f9q.abortAnimation();
            a(0);
            return false;
        }
        this.f9q.startScroll(left, top, i6, i7, a(this.s, i6, i7, i4, i5));
        a(2);
        return true;
    }
    ...
    public void abort() {
        cancel();
        if (this.a == 2) {
            int currX = this.f9q.getCurrX();
            int currY = this.f9q.getCurrY();
            this.f9q.abortAnimation();
            int currX2 = this.f9q.getCurrX();
            int currY2 = this.f9q.getCurrY();
    ...
    public boolean continueSettling(boolean z) {
        if (this.a == 2) {
            boolean computeScrollOffset = this.f9q.computeScrollOffset();
            int currX = this.f9q.getCurrX();
            int currY = this.f9q.getCurrY();
            ...
            if (computeScrollOffset && currX == this.f9q.getFinalX() && currY == this.f9q.getFinalY()) {
                this.f9q.abortAnimation();
    ...
    public void flingCapturedView(int i2, int i3, int i4, int i5) {
        ...
        this.f9q.fling(this.s.getLeft(), this.s.getTop(), (int) this.l.getXVelocity(this.c), (int) this.l.getYVelocity(this.c), i2, i4, i3, i5);
        a(2);
    }
    ...
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r18) {
        ...
        L_0x0030:
            ...
            android.widget.ViewDragHelper$Callback r3 = r0.r
            int r4 = r0.p
            r1 = r1 & r4
        ...
        L_0x00a0:
            ...
            int r12 = (int) r9
            int r13 = r11 + r12
            android.widget.ViewDragHelper$Callback r14 = r0.r
            int r12 = r14.clampViewPositionHorizontal(r7, r13, r12)
            int r13 = r7.getTop()
            int r14 = (int) r10
            int r15 = r13 + r14
            android.widget.ViewDragHelper$Callback r5 = r0.r
            int r5 = r5.clampViewPositionVertical(r7, r15, r14)
            android.widget.ViewDragHelper$Callback r14 = r0.r
            int r14 = r14.getViewHorizontalDragRange(r7)
            android.widget.ViewDragHelper$Callback r15 = r0.r
        ...
        L_0x00e6:
            ...
            goto L_0x0075
        L_0x00e9:
            r17.a((android.view.MotionEvent) r18)
            goto L_0x0025
        L_0x00ee:
            r17.cancel()
            goto L_0x0025
